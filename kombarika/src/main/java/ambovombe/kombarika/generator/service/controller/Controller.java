...
public class Controller{
    ...
    public String save(String table){
        ...
        String type = this.getControllerProperty().getReturnType().replace("?", ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(table)));
        String syntaxe = this.getLanguageProperties().getMethodSyntax().replace("{", " throws Exception {");
    ...
    public String getControllerField(String table){
        ...
        if(!this.getControllerProperty().getField().equals("") && !this.getControllerProperty().getAnnotationField().equals("")){
            res += "\t"
                    ...
                    + "\t" + this.getControllerProperty().getField().replace("?", ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(table)).replace("##", ObjectUtility.formatToCamelCase(table))) + "\n";
        }else if (!this.getControllerProperty().getField().equals("")){
            res += "\t" + this.getControllerProperty().getField().replace("?", ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(table))).replace("##", ObjectUtility.formatToCamelCase(table)) + "\n";
        }
        return res;
    }
    ...
    public String getEncapsulation(String table){
        String rep = "";
        rep += this.getLanguageProperties().getEncapsulation()
        .replace("#type#", ObjectUtility.capitalize(table))
        .replace("#Field#", ObjectUtility.formatToCamelCase(ObjectUtility.capitalize(table)))
        .replace("#field#", ObjectUtility.formatToCamelCase(table));
        return rep;
    }
    ...
    public String generateController(String template, String table, String packageName, String repository, String entity, String framework) throws Exception {
        String res = template.replace("#package#", GeneratorService.getPackage(this.getLanguageProperties(), packageName))
                ...
                // .replace("#encapsulation#", getEncapsulation(table));
        return res;
    }
}
