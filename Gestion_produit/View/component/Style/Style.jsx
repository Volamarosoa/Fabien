...
function Style(){
  ...
  const handleSelectItem = (itemKey) => {
    handleShow2();
    const itemDetails = style.find(item => item.id === itemKey);
...
//////// DELETE
  const handleDeleteClick = async (item) => {
	...
	const handleInputStyleChange = (event) => {
  ...
  return (
	...
	<div className="mb-3"> 
	 	...
	 	<input className="form-control" type="text" name="style" />
	</div>
		...
		<td>{item.id}</td>
              ...
              <Modal show={show2} onHide={handleClose2}>
                  <Modal.Header closeButton>
                      <Modal.Title>Update Style</Modal.Title>
                  </Modal.Header>
                  <Modal.Body>    
                      <form action="" method="" id="update" onSubmit={handleUpdateSubmit}>
	<div className="mb-3"> 
	 	<label className="form-label">Style</label> 
	 	<input className="form-control" type="text" name="style" onChange={handleInputStyleChange} value={selectedItem ? selectedItem.style:''} />
	</div>
	<div className="mb-3"> 
