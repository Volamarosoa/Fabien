...
function Matiere(){
  ...
  const handleSelectItem = (itemKey) => {
    handleShow2();
    const itemDetails = matiere.find(item => item.id === itemKey);
...
//////// DELETE
  const handleDeleteClick = async (item) => {
	...
	const handleInputMatiereChange = (event) => {
  ...
  return (
	...
	<div className="mb-3"> 
	 	...
	 	<input className="form-control" type="text" name="matiere" />
	</div>
		...
		<td>{item.matiere}</td>
              ...
              <Modal show={show2} onHide={handleClose2}>
                  <Modal.Header closeButton>
                      <Modal.Title>Update Matiere</Modal.Title>
                  </Modal.Header>
                  <Modal.Body>    
	...
	<div className="mb-3"> 
	 	<label className="form-label">Matiere</label> 
	 	<input className="form-control" type="text" name="matiere" onChange={handleInputMatiereChange} value={selectedItem ? selectedItem.matiere:''} />
	</div>
